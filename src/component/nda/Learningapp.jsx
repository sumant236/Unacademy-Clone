  ...
  return (
    ...
    <div className={style.Learningapp}>
        <div>
          ...
          <div className={style.Learningapp}>
            <img src='https://static.uacdn.net/production/_next/static/images/app_store.png?q=75&w=1920' alt='apple'/>  
            <img src='https://static.uacdn.net/production/_next/static/images/play_store.png?q=75&w=1920' alt='google'/>           
          </div>      
        </div>
